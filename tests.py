...
def selection_roulette2(population_scores: List[tuple[int, int]], population_size: int):
...
# selection_prop
# print(selection_roulette2(population_scores, 6))
# print(selection_roulette2(population_scores2, 6))
